...
const MinimalAbout = () => {
  const skills = [
    { category: 'Frontend', items: ['React', 'TypeScript', 'Next.js', 'Vue.js'] },
    { category: 'Backend', items: ['Node.js', 'Python', 'PostgreSQL', 'MongoDB'] },
    { category: 'Tools', items: ['AWS', 'Docker', 'Git', 'Figma'] },
    { category: 'Specialties', items: ['AI/ML', 'Web3', 'Performance', 'Security'] }
  ];
